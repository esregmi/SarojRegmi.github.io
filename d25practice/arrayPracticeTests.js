...
const sumOf = myExports.sumOf; 
const avgOf = myExports.avgOf; 
...
describe("reduce Practice", function () {
    ...
    it("find sum of numbers", function () {
        assert.strictEqual(sumOf(numArray), 422);
    });
    it("find average of numbers", function () {
        assert.strictEqual(avgOf(numArray), 52.75);
    });
    it("find max of numbers", function () {
        assert.strictEqual(maxNumber(numArray), 300);
    });
